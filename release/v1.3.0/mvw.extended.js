console.info("https:github.com/DataDink/mvw/release/v1.3.0/mvw.extended.js");
(DEBUG_FILE_SOURCE => {
    /**
...
* @source:        https://github.com/DataDink/mvw/src/extended/AutoSizeEvent.js
* @author:        DataDink - https://github.com/DataDink
* @dependencies:  MVW.js
...
* @source:        https://github.com/DataDink/mvw/src/extended/EventSource.prototype.promise.js
* @author:        DataDink - https://github.com/DataDink
* @dependencies:  MVW.js
...
* @source:        https://github.com/DataDink/mvw/src/extended/String.prototype.wrap.js
* @author:        DataDink - https://github.com/DataDink
* @dependencies:  n/a
...
* @source:        https://github.com/DataDink/mvw/src/extended/console-formatters.js
* @author:        DataDink - https://github.com/DataDink
* @dependencies:  n/a
* @notes:         Utility extension to simplify color console output
*/
    ((levels, formatter) => (catalog => levels.map((level => console[level])).forEach((root => Object.keys(catalog).filter((m => !(m in root))).forEach((index => Object.defineProperty(root, index, {
        enumerable: true,
        configurable: false,
        get: () => ((styles, write, log) => (logger => logger[index])(Object.keys(catalog).reduce(((logger, method) => Object.defineProperty(logger, method, {
            enumerable: true,
            configurable: false,
...
MVW.Settings.register("version", "extendedv1.3.0");
